...
function register_postTypeSearch_elementor_widgets( $widgets_manager ) {
    ...
    /** Custom Grid Widget **/
    require_once( __DIR__ . '/inc/custom-grid.php' );
	$widgets_manager->register( new \customGrid_widget_elementore );

    /** Succes Widget **/
	require_once( __DIR__ . '/inc/succesSlider-custom.php' );
	$widgets_manager->register( new \SuccesSlider_widget_elementore );
